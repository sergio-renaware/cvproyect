...
const SocialIcons = () => {
    return (
        <div className="social-icons">
            <a target="_blank" rel="noreferrer" href="https://www.instagram.com/serbeld/" title="Instagram">
            ...
            <a target="_blank" rel="noreferrer" href="https://github.com/Serbeld" title="Github">
            ...
            <a target="_blank" rel="noreferrer" href="https://co.linkedin.com/in/serbeld" title="Linkedin">
